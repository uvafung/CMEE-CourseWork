# Name: SDM_HOG_citisci_XMamPred_model_evaluation_3_Uva.R
...
# ggplot(enviro, aes(BadgCS250, id)) + geom_point() # Badger presence
# ggplot(enviro, aes(GDN100, id)) + geom_point() # Garden cover
# ggplot(enviro, aes(FoxCS250, id)) + geom_point() # Fox presence
# 
...
enviro_var14 <- enviro[, c('ALT1000', 'AMN750', 'CEM1000', 'PLPK100', 'SPRT1000',
                           'WAT100', 'WD100', 'TRAF100', 'IMP100', 'DTCH100',
                           'SEMI500', 'TERR750', 'logHD100',
                           'GDN100')]

vif(enviro_var14) # calculate vif score
...
glm_qua_selected <- glm(HOGns ~  
                          GDN100 + ALT1000 + PLPK100 + 
                          WAT100 + WD100 + poly(IMP100, 2) + DTCH100 + TERR750 + 
                          poly(logHD100, 2) + TRAF100, 
               family = binomial(link="logit"), data = enviro)
...
# 
# # GDN100
# gge_GDN100  <- ggpredict(glm_qua_step, 
...
# 
# # ALT1000
# gge_ALT1000 <- ggpredict(glm_qua_step, 
...
# 
#  # AMN750
# gge_AMN750 <- ggpredict(glm_qua_step, 
...
# 
# # # CEM1000
# # gge_CEM1000 <- ggpredict(glm_qua_step, 
...
# 
# # PLPK100
# gge_PLPK100 <- ggpredict(glm_qua_step, 
...
# 
# # # SPRT1000 
# # gge_SPRT1000 <- ggpredict(glm_qua_step, 
# #                          terms = c('SPRT1000 [all]'), ci.lvl = 0.95, 
# #                          typical = 'mean', back.transform = T)
# # 
# # ggplot(gge_SPRT1000, aes(x, predicted)) +
# #   geom_line() +
# #   geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = .1) +
# #   labs(y= "Predicted HOGns", x = "SPRT1000") 
# 
# 
# 
# # WAT100 
# gge_WAT100 <- ggpredict(glm_qua_step, 
...
# 
# # WD100 
# gge_WD100 <- ggpredict(glm_qua_step, 
...
# 
# # # TRAF100 
# # gge_TRAF100 <- ggpredict(glm_qua_step, 
...
# 
# # IMP100
# gge_IMP100  <- ggpredict(glm_qua_step, 
...
# 
# # DTCH100
# gge_DTCH100 <- ggpredict(glm_qua_step,
...
# 
# # SEMI500  
# gge_SEMI500   <- ggpredict(glm_qua_step, 
...
# 
# # TERR750
# gge_TERR750 <- ggpredict(glm_qua_step,
#                             terms = c('TERR750   [all]'), ci.lvl = 0.95,
#                             typical = 'mean', back.transform = T)
# 
# ggplot(gge_TERR750, aes(x, predicted)) +
#   geom_line() +
#   geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = .1) +
#   labs(y= "Predicted HOGns", x = "TERR750")
# 
# 
# # logHD100
# gge_logHD100 <- ggpredict(glm_qua_step, 
...
# 
# # BadgCS250 
# gge_BadgCS250  <- ggpredict(glm_qua_step, 
#                           terms = c('BadgCS250 [all]'), ci.lvl = 0.95, 
#                           typical = 'mean', back.transform = T)
# 
# ggplot(gge_BadgCS250 , aes(x, predicted)) +
#   geom_line() +
#   geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = .1) +
#   labs(y= "Predicted HOGns", x = "BadgCS250" )
# 
# 
# # FoxCS250 
# gge_FoxCS250  <- ggpredict(glm_qua_step, 
#                             terms = c('FoxCS250 [all]'), ci.lvl = 0.95, 
#                             typical = 'mean', back.transform = T)
# 
# ggplot(gge_FoxCS250 , aes(x, predicted)) +
#   geom_line() +
#   geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = .1) +
#   labs(y= "Predicted HOGns", x = "FoxCS250" )
# 
...
write.csv(auc_GLMmod,"../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_GLM_auc.csv")
write.csv(tss_GLMmod,"../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_GLM_tss.csv")
...
enviro_biomod2 <- enviro[, c('Easting','Northing','HOGns', 
                             'GDN100', 'ALT1000', 'PLPK100', 'WAT100',
                             'WD100', 'IMP100', 'DTCH100', 'TERR750', 
                             'logHD100', 'TRAF100')] # all 10 variables


# convert response variable (HOGns) to numeric
enviro_biomod2$HOGns <- as.numeric(enviro_biomod2$HOGns) 

# # convert badger presence (BadgCS250) and fox presence (FoxCS250) to factor
# enviro_biomod2$BadgCS250 <- as.factor(enviro_biomod2$BadgCS250) 
# enviro_biomod2$FoxCS250 <- as.factor(enviro_biomod2$FoxCS250) 
...
vars = c('GDN100', 'ALT1000', 'PLPK100', 'WAT100',
         'WD100', 'IMP100', 'DTCH100', 'TERR750', 
         'logHD100', 'TRAF100')
...
stargazer(eval_table,                
          summary = FALSE,
          type = "text",
          out = "../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_evaluation_scores_UF.txt")
...
ggsave("../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_evaluation_plot_UF.pdf")
...
ggsave("../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/_varimp_UF.pdf")
...
ggsave("../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/_varimpB_UF.pdf")
...
ggsave("../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_blocking_map.pdf")
...
stargazer(scores_all_blocking,                
          summary = FALSE,
          type = "text",
          out = "../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_blocking_evaluation_scores_UF.txt")
...
ggsave("../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_blocking_evaluation_plot_UF.pdf")
...
ggsave(paste0("../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_blocked_varimp_UF.pdf"))
...
enviro_random_bg <- enviro_random_bg %>% 
  distinct(Easting,Northing,HOGns,
           GDN100, ALT1000, PLPK100, WAT100, 
           WD100, IMP100, DTCH100, TERR750, 
           logHD100, TRAF100, .keep_all = TRUE)
...
ggsave("../../../results/CitiSci/AllYear_XMammalPred/Hedgehog/hog_varimp_UF.pdf")
