# Name: SDM_FOX_citisci_AllYear_model_evaluation_3.R
...
ggplot(enviro, aes(AMN500, id)) + geom_point() # % Amenity cover
...
ggplot(enviro, aes(DWL750, id)) + geom_point() # Housing density
ggplot(enviro, aes(HD500, id)) + geom_point() # Human population density
ggplot(enviro, aes(BadgCS750, id)) + geom_point() # Badger presence
ggplot(enviro, aes(GDN1000, id)) + geom_point() # Garden cover
...
ggplot(enviro, aes(logHD500, id)) + geom_point() # log Human population density
ggplot(enviro, aes(logDWL750, id)) + geom_point() # log housing density
...
glm_qua <- glm(FOXns ~  
                 ...
                 poly(logHD500, 2) + logTRAF1000 + BadgCS750 + HogCS100, 
                      family = binomial(link="logit"), data = enviro)
...
for (i in 1:100){  # i = 100 repeat split sample cross validation
  ...
  glm.fit_GLM = glm(FOXns ~  # simple GLM
                      ...
                      SEMI500 + TERR1000 + logHD500 + logTRAF1000 + BadgCS750 + 
                      HogCS100, 
  ...
  glm.fit_GLM_Qua = glm(FOXns ~  # GLM with quadratic variables
                          ...
                          SEMI500 + TERR1000 + poly(logHD500, 2) + logTRAF1000 + BadgCS750 + 
                          HogCS100,
...
write.csv(auc_GLMmod, "../../../results/CitiSci/AllYear/Fox/fox_auc_GLMmod.csv")
write.csv(tss_GLMmod, "../../../results/CitiSci/AllYear/Fox/fox_tss_GLMmod.csv")
...
enviro_biomod2 <- enviro[, c('Easting','Northing','FOXns', 
                             'GDN1000', 'ALT750', 'PLPK100', 'WAT750',
                             'WD1000', 'IMP750', 'DTCH1000', 'SEMI500', 'TERR1000', 
                             'logHD500', 'logTRAF1000', 'BadgCS750', 'HogCS100')] # all 13 variables
...
vars = c('GDN1000', 'ALT750', 'PLPK100', 'WAT750',
         'WD1000', 'IMP750', 'DTCH1000', 'SEMI500', 'TERR1000', 
         'logHD500', 'logTRAF1000', 'BadgCS750', 'HogCS100')
...
stargazer(eval_table,                
          summary = FALSE,
          type = "text",
          out = "../../../results/CitiSci/AllYear/Fox/fox_evaluation_scores_UF.txt")
...
ggsave("../../../results/CitiSci/AllYear/Fox/fox_evaluation_plot_UF.pdf")
...
ggsave("../../../results/CitiSci/AllYear/Fox/fox_varimp_UF.pdf")
...
ggsave("../../../results/CitiSci/AllYear/Fox/fox_varimpB_UF.pdf")
...
ggsave("../../../results/CitiSci/AllYear/Fox/fox_blocking_map.pdf")
...
stargazer(scores_all_blocking,                
          summary = FALSE,
          type = "text",
          out = "../../../results/CitiSci/AllYear/Fox/fox_blocking_evaluation_scores_UF.txt")
...
ggsave("../../../results/CitiSci/AllYear/Fox/fox_blocking_evaluation_plot_UF.pdf")
...
ggsave(paste0("../../../results/CitiSci/AllYear/Fox/fox_blocked_varimp_UF.pdf"))
...
enviro_random_bg <- enviro_random_bg %>% 
  distinct(Easting,Northing,FOXns,
           GDN1000, ALT750, PLPK100, WAT750, 
           WD1000, IMP750, DTCH1000, SEMI500, TERR1000, 
           logHD500, logTRAF1000, BadgCS750, HogCS100, .keep_all = TRUE)
