...
init_community_max(11)

init_community_min(4)

species_richness(init_community_min(10))

species_richness(init_community_min(1))
...
neutral_step(init_community_min(10))
...
neutral_time_series_speciation(c(10,5,13), speciation_rate = 0.2, duration = 10)
...
cluster_run(speciation_rate = 0.1, size=100, wall_time=1, interval_rich=1,
